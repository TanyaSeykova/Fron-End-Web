function validateForm() {
   ...
   let email = document.getElementsByClassName("auth-input")[1].value;
   let username = document.getElementsByClassName("auth-input")[0].value;
   let password = document.getElementsByClassName("auth-input")[2].value;
